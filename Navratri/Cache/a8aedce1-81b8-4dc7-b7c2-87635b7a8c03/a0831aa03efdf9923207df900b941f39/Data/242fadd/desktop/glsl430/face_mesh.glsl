...
//sampler sampler maskTexSmpSC 2:28
...
//texture texture2D maskTex 2:5:2:28
...
//texture texture2DArray maskTexArrSC 2:44:2:28
...
#if (baseTexLayout==2)
{
l9_1=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_1=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#endif
float l9_3=clamp(l9_0.w,0.0,1.0);
...
#endif
if (dot(normalize(sc_Camera.position-varPos),l9_2)>=(-0.050000001))
{
uvec3 l9_4=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_4.x,l9_4.y,l9_4.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_5=abs(l9_2);
vec3 l9_6=l9_2/vec3(dot(l9_5,vec3(1.0)));
float l9_7=clamp(-l9_6.z,0.0,1.0);
float l9_8=l9_6.x;
float l9_9;
if (l9_8>=0.0)
{
...
uvec2 l9_13=uvec2(packHalf2x16(vec2(l9_10,0.0)),packHalf2x16(vec2(l9_11+l9_12,0.0)));
normal_and_more=uvec4(l9_13.x,l9_13.y,normal_and_more.z,normal_and_more.w);
...
{
l9_14=uint(clamp(roughness,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_14|uint((receiverId%32)<<int(10u));
}
else
{
...
#if (baseTexLayout==2)
{
l9_6=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_6=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_0,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#endif
float l9_8=clamp(l9_5.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_9=max(l9_5.xyz,vec3(0.0));
vec4 l9_10;
#if (sc_ProjectiveShadowsCaster)
{
...
#else
{
l9_10=ngsCalculateLighting(l9_9,l9_8,l9_7,l9_2,l9_3,Port_Emissive_N023,clamp(metallic,0.0,1.0),clamp(roughness,0.0,1.0),Port_AO_N023,Port_SpecularAO_N023);
}
#endif
...
l9_13=(clamp((l9_14.x-(1.0-radius))+0.001,Port_Input1_N047+0.001,Port_Input2_N047+0.001)-0.001)/l9_15;
}
#else
{
l9_13=Port_Input2_N051;
}
#endif
l9_12=l9_13;
}
#else
{
l9_12=Port_Input2_N010;
}
#endif
float l9_16=l9_5.w*l9_12;
float l9_17=clamp(l9_16+0.001,Port_Input1_N001+0.001,Port_Input2_N001+0.001)-0.001;
vec4 l9_18=vec4(l9_11.x,l9_11.y,l9_11.z,vec4(0.0).w);
l9_18.w=l9_17;
if (isProxyMode)
{
vec4 l9_19;
...
{
vec3 l9_36=sc_GetFramebufferColor().xyz;
vec3 l9_37=mix(l9_36,definedBlend(l9_36,l9_18.xyz).xyz,vec3(l9_17));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_39=vec4(mix(vec3(1.0),l9_18.xyz,vec3(l9_17)),l9_17);
}
#else
{
vec4 l9_40;
...
#endif
l9_40=vec4(l9_18.xyz*l9_41,l9_41);
}
#else
{
l9_40=l9_18;
