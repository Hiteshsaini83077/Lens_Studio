...
#endif
float l9_4=clamp(l9_1.w,0.0,1.0);
...
#endif
vec3 l9_5=max(l9_1.xyz,vec3(0.0));
vec4 l9_6;
#if (sc_ProjectiveShadowsCaster)
{
l9_6=vec4(l9_5,l9_4);
...
#else
{
float l9_7=clamp(metallic,0.0,1.0);
float l9_8=clamp(roughness,0.0,1.0);
vec3 l9_9=ssSRGB_to_Linear(l9_5);
vec3 l9_10=normalize(l9_3);
vec3 l9_11=ssSRGB_to_Linear(Port_Emissive_N023);
vec3 l9_12;
#if (sc_SSAOEnabled)
{
l9_12=evaluateSSAO(varPos);
}
#else
{
l9_12=Port_AO_N023;
...
#endif
vec3 l9_13=vec3(l9_7);
vec3 l9_14=mix(vec3(0.039999999),l9_9*l9_7,l9_13);
vec3 l9_15=mix(l9_9*(1.0-l9_7),vec3(0.0),l9_13);
SurfaceProperties l9_16=SurfaceProperties(l9_15,l9_4,l9_10,varPos,l9_0,l9_7,l9_8,l9_11,l9_12,Port_SpecularAO_N023,vec3(1.0),l9_14);
vec4 l9_17=vec4(1.0);
vec3 l9_18;
vec3 l9_19;
vec3 l9_20;
...
l9_26=vec3(0.0);
l9_25=vec3(0.0);
LightingComponents l9_32;
LightProperties l9_33;
SurfaceProperties l9_34;
vec3 l9_35;
int l9_36=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_36<sc_DirectionalLightsCount)
{
LightingComponents l9_37=accumulateLight(LightingComponents(l9_25,l9_26,l9_31,l9_30,l9_28,l9_27),LightProperties(sc_DirectionalLights[l9_36].direction,sc_DirectionalLights[l9_36].color.xyz,sc_DirectionalLights[l9_36].color.w*l9_17[(l9_29<3) ? l9_29 : 3]),l9_16,l9_0);
l9_31=l9_37.indirectDiffuse;
l9_30=l9_37.indirectSpecular;
l9_29++;
l9_28=l9_37.emitted;
l9_27=l9_37.transmitted;
l9_26=l9_37.directSpecular;
l9_25=l9_37.directDiffuse;
l9_36++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_54<sc_PointLightsCount)
{
vec3 l9_56=sc_PointLights[l9_54].position-varPos;
vec3 l9_57=normalize(l9_56);
float l9_58=l9_17[(l9_55<3) ? l9_55 : 3];
float l9_59=clamp((dot(l9_57,sc_PointLights[l9_54].direction)*sc_PointLights[l9_54].angleScale)+sc_PointLights[l9_54].angleOffset,0.0,1.0);
float l9_60=(sc_PointLights[l9_54].color.w*l9_58)*(l9_59*l9_59);
float l9_61;
if (sc_PointLights[l9_54].falloffEnabled)
{
l9_61=l9_60*computeDistanceAttenuation(length(l9_56),sc_PointLights[l9_54].falloffEndDistance);
}
else
{
l9_61=l9_60;
...
l9_47=l9_55+1;
LightingComponents l9_62=accumulateLight(LightingComponents(l9_41,l9_42,l9_46,l9_45,l9_44,l9_43),LightProperties(l9_57,sc_PointLights[l9_54].color.xyz,l9_61),l9_16,l9_0);
l9_48=l9_62.directDiffuse;
l9_49=l9_62.directSpecular;
l9_50=l9_62.indirectDiffuse;
l9_51=l9_62.indirectSpecular;
l9_52=l9_62.emitted;
l9_53=l9_62.transmitted;
l9_46=l9_50;
l9_45=l9_51;
l9_55=l9_47;
l9_44=l9_52;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_66=abs(varShadowTex-vec2(0.5));
vec4 l9_67=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_66.x,l9_66.y),0.5);
l9_65=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_67.xyz,vec3(sc_ShadowColor.w)),vec3(l9_67.w*sc_ShadowDensity));
}
#else
{
l9_65=vec3(1.0);
...
{
vec2 l9_69=calcPanoramicTexCoordsFromDir(l9_10,sc_EnvmapRotation.y);
vec4 l9_70;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_71=calcSeamlessPanoramicUvsForSampling(l9_69,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_71=l9_69;
...
#endif
l9_70=sc_EnvmapSpecularSampleViewIndexBias(l9_71,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_72;
...
{
vec2 l9_73=calcSeamlessPanoramicUvsForSampling(l9_69,sc_EnvmapDiffuseSize.xy,0.0);
int l9_74;
...
#endif
l9_72=sc_SampleView(sc_EnvmapDiffuseDims.xy,l9_73,sc_EnvmapDiffuseLayout,l9_74,-13.0,sc_EnvmapDiffuse);
}
#else
{
l9_72=sc_EnvmapSpecularSampleViewIndexBias(l9_69,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_70=l9_72;
}
#endif
l9_68=(l9_70.xyz*(1.0/l9_70.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_75;
...
float l9_78=l9_76.y;
float l9_79=l9_76.z;
l9_75=(((((((sc_Sh[8]*0.42904299)*((l9_77*l9_77)-(l9_78*l9_78)))+((sc_Sh[6]*0.74312502)*(l9_79*l9_79)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_77*l9_78))+(sc_Sh[7]*(l9_77*l9_79)))+(sc_Sh[5]*(l9_78*l9_79)))*0.85808599))+((((sc_Sh[3]*l9_77)+(sc_Sh[1]*l9_78))+(sc_Sh[2]*l9_79))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_75=vec3(0.0);
...
{
l9_81=l9_68+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_82=l9_68;
l9_82.x=l9_68.x+(1e-06*sc_AmbientLights[0].color.x);
l9_81=l9_82;
}
#endif
l9_80=l9_81;
...
{
l9_84=l9_80+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_85=l9_80;
l9_85.x=l9_80.x+(1e-06*sc_AmbientLights[1].color.x);
l9_84=l9_85;
}
#endif
l9_83=l9_84;
...
{
l9_87=l9_83+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_88=l9_83;
l9_88.x=l9_83.x+(1e-06*sc_AmbientLights[2].color.x);
l9_87=l9_88;
}
#endif
l9_86=l9_87;
...
{
vec3 l9_90;
l9_90=sc_LightEstimationData.ambientLight;
vec3 l9_91;
int l9_92=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_92<sc_LightEstimationSGCount)
{
float l9_93=dot(sc_LightEstimationData.sg[l9_92].axis,l9_10);
float l9_94=exp(-sc_LightEstimationData.sg[l9_92].sharpness);
float l9_95=l9_94*l9_94;
float l9_96=1.0/sc_LightEstimationData.sg[l9_92].sharpness;
float l9_97=(1.0+(2.0*l9_95))-l9_96;
float l9_98=sqrt(1.0-l9_97);
float l9_99=0.36000001*l9_93;
float l9_100=(1.0/(4.0*0.36000001))*l9_98;
float l9_101=l9_99+l9_100;
float l9_102;
if (step(abs(l9_99),l9_100)>0.5)
{
l9_102=(l9_101*l9_101)/l9_98;
}
else
{
l9_102=clamp(l9_93,0.0,1.0);
}
l9_91=l9_90+((((sc_LightEstimationData.sg[l9_92].color/vec3(sc_LightEstimationData.sg[l9_92].sharpness))*6.2831855)*((l9_97*l9_102)+(((l9_94-l9_95)*l9_96)-l9_95)))/vec3(3.1415927));
l9_90=l9_91;
l9_92++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_104=clamp(pow(l9_8,0.66666669),0.0,1.0)*5.0;
vec2 l9_105=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_10,reflect(-l9_0,l9_10),l9_8),sc_EnvmapRotation.y);
vec4 l9_106;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_107=floor(l9_104);
float l9_108=ceil(l9_104);
l9_106=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_105,sc_EnvmapSpecularSize.xy,l9_107),sc_EnvmapSpecularGetStereoViewIndex(),l9_107),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_105,sc_EnvmapSpecularSize.xy,l9_108),sc_EnvmapSpecularGetStereoViewIndex(),l9_108),vec4(l9_104-l9_107));
}
#else
{
l9_106=sc_EnvmapSpecularSampleViewIndexLevel(l9_105,sc_EnvmapSpecularGetStereoViewIndex(),l9_104);
}
#endif
l9_103=vec3(0.0)+((((l9_106.xyz*(1.0/l9_106.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_16,abs(dot(l9_10,l9_0))));
}
#else
{
l9_103=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_110=clamp(l9_8*l9_8,0.0099999998,1.0);
vec3 l9_111;
l9_111=sc_LightEstimationData.ambientLight*l9_14;
int l9_112=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_112<sc_LightEstimationSGCount)
{
float l9_113=l9_110*l9_110;
vec3 l9_114=reflect(-l9_0,l9_10);
float l9_115=dot(l9_10,l9_0);
float l9_116=(2.0/l9_113)/(4.0*max(l9_115,9.9999997e-05));
float l9_117=length((l9_114*l9_116)+(sc_LightEstimationData.sg[l9_112].axis*sc_LightEstimationData.sg[l9_112].sharpness));
float l9_118=clamp(dot(l9_10,l9_114),0.0,1.0);
float l9_119=clamp(l9_115,0.0,1.0);
float l9_120=1.0-l9_113;
l9_111+=((((((((vec3(1.0/(3.1415927*l9_113))*exp((l9_117-l9_116)-sc_LightEstimationData.sg[l9_112].sharpness))*sc_LightEstimationData.sg[l9_112].color)*6.2831855)*(1.0-exp((-2.0)*l9_117)))/vec3(l9_117))*((1.0/(l9_118+sqrt(l9_113+((l9_120*l9_118)*l9_118))))*(1.0/(l9_119+sqrt(l9_113+((l9_120*l9_119)*l9_119))))))*(l9_14+((vec3(1.0)-l9_14)*pow(1.0-clamp(dot(l9_114,normalize(l9_114+l9_0)),0.0,1.0),5.0))))*l9_118);
l9_112++;
continue;
}
else
...
l9_124=vec3(0.0);
l9_123=vec3(0.0);
l9_122=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_15,vec3(l9_4));
l9_121=1.0;
}
#else
{
...
#endif
vec3 l9_126=l9_123*l9_12;
vec3 l9_127=l9_124+l9_126;
vec3 l9_128=l9_15*l9_127;
vec3 l9_129=l9_109*Port_SpecularAO_N023;
vec3 l9_130=l9_63+l9_129;
vec3 l9_131;
if (l9_125)
{
l9_131=l9_128*srgbToLinear(l9_121);
}
else
{
l9_131=l9_128;
}
vec3 l9_132=l9_131+l9_130;
vec3 l9_133=(l9_132+l9_11)+l9_122;
float l9_134=l9_133.x;
vec4 l9_135=vec4(l9_134,l9_133.yz,l9_121);
vec4 l9_136;
#if (sc_IsEditor)
{
vec4 l9_137=l9_135;
l9_137.x=l9_134+((l9_12.x*Port_SpecularAO_N023.x)*9.9999997e-06);
l9_136=l9_137;
}
#else
{
...
{
vec3 l9_139=l9_136.xyz*1.8;
vec3 l9_140=(l9_136.xyz*(l9_139+vec3(1.4)))/((l9_136.xyz*(l9_139+vec3(0.5)))+vec3(1.5));
l9_138=vec4(l9_140.x,l9_140.y,l9_140.z,l9_136.w);
}
#else
{
l9_138=l9_136;
...
#endif
vec3 l9_141=vec3(linearToSrgb(l9_138.x),linearToSrgb(l9_138.y),linearToSrgb(l9_138.z));
l9_6=vec4(l9_141.x,l9_141.y,l9_141.z,l9_138.w);
}
#endif
vec4 l9_142=max(l9_6,vec4(0.0));
float l9_143;
...
#endif
vec4 l9_146=sc_SampleTextureBiasOrLevel(maskTexDims.xy,maskTexLayout,l9_145,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_maskTex)!=0),maskTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_maskTex,SC_SOFTWARE_WRAP_MODE_V_maskTex),(int(SC_USE_UV_MIN_MAX_maskTex)!=0),maskTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_maskTex)!=0),maskTexBorderColor,0.0,maskTex);
float l9_147;
...
l9_144=(clamp((l9_146.x-(1.0-radius))+0.001,Port_Input1_N047+0.001,Port_Input2_N047+0.001)-0.001)/l9_147;
}
#else
{
l9_144=Port_Input2_N051;
}
#endif
l9_143=l9_144;
}
#else
{
l9_143=Port_Input2_N010;
}
#endif
float l9_148=l9_1.w*l9_143;
float l9_149=clamp(l9_148+0.001,Port_Input1_N001+0.001,Port_Input2_N001+0.001)-0.001;
vec4 l9_150=vec4(l9_142.x,l9_142.y,l9_142.z,vec4(0.0).w);
l9_150.w=l9_149;
vec4 l9_151;
#if (sc_ProjectiveShadowsCaster)
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_153=clamp(l9_149*2.0,0.0,1.0);
}
#else
{
float l9_154;
...
{
l9_154=clamp(dot(l9_150.xyz,vec3(l9_149)),0.0,1.0);
}
#else
{
float l9_155;
...
#if (sc_BlendMode_Multiply)
{
l9_156=(1.0-dot(l9_150.xyz,vec3(0.33333001)))*l9_149;
}
#else
{
float l9_157;
...
{
l9_157=(1.0-clamp(dot(l9_150.xyz,vec3(1.0)),0.0,1.0))*l9_149;
}
#else
{
float l9_158;
#if (sc_BlendMode_ColoredGlass)
{
l9_158=clamp(dot(l9_150.xyz,vec3(1.0)),0.0,1.0)*l9_149;
}
#else
{
float l9_159;
#if (sc_BlendMode_Add)
{
l9_159=clamp(dot(l9_150.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_160;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_160=clamp(dot(l9_150.xyz,vec3(1.0)),0.0,1.0)*l9_149;
}
#else
{
float l9_161;
...
{
l9_161=dot(l9_150.xyz,vec3(0.33333001))*l9_149;
}
#else
{
float l9_162;
#if (sc_BlendMode_Min)
{
l9_162=1.0-clamp(dot(l9_150.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_163;
#if (sc_BlendMode_Max)
{
l9_163=clamp(dot(l9_150.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_163=1.0;
...
#endif
l9_151=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_150.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_152);
}
#else
{
vec4 l9_164;
...
{
vec3 l9_166=sc_GetFramebufferColor().xyz;
vec3 l9_167=mix(l9_166,definedBlend(l9_166,l9_150.xyz).xyz,vec3(l9_149));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_169=vec4(mix(vec3(1.0),l9_150.xyz,vec3(l9_149)),l9_149);
}
#else
{
vec4 l9_170;
...
#endif
l9_170=vec4(l9_150.xyz*l9_171,l9_171);
}
#else
{
l9_170=l9_150;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_179=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
...
#if (sc_OITCompositingPass)
{
vec2 l9_192=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
